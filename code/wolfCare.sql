...
CREATE TABLE `doctors` (
	...
	`secondaryspecialty` varchar(255) NOT NULL,
...
INSERT INTO `doctors` (`doctorid`, `firstname`, `lastname`, `primaryspecality`, `secondaryspecialty`, `type`, `degree`, `phone`, `email`, `gender`, `yoe`, `approvalstatus`, `isactive`, `lastmoddate`) VALUES
('1001','John','Doe','Dermatology','Family Medicine','Prescriber','MD','9192383821','johndoe@gmail.com','Male','3','TRUE','TRUE','20221129'),
('1002','Jack','Black','Family Medicine',NULL,'Prescriber','MD','9192383822','jackblack@gmail.com','Male','12','TRUE','TRUE','20221129'),
('1003','Ron','Mccarthy','Oncology',NULL,'Prescriber','MBBS','9192383823','ronmccarthy@gmail.com','Male','20','TRUE','TRUE','20221129'),
('1004','Jill','Hoffman','Othopedic','Family Medicine','Prescriber','MD','9192383824','jillhoffman@gmail.com','Female','3','TRUE','TRUE','20221129'),
('1005','Nigel','Tucker','Dermatology',NULL,'Prescriber','MBBS','9192383825','nigeltucker@gmail.com','Male','5','TRUE','TRUE','20221129'),
('1006','Ben','Johnson','General Physician','Family Medicine','Prescriber','MBBS','9192383826','benjohnson@gmail.com','Male','3','TRUE','TRUE','20221129'),
('1007','Sarah','Mikaelson','Neurology',NULL,'Prescriber','MD','9192383827','sarahmikaelson@gmail.com','Female','5','TRUE','TRUE','20221129'),
('1008','Dan','Peters','Dermatology',NULL,'Prescriber','MBBS','9192383828','danpeters@gmail.com','Male','6','TRUE','TRUE','20221129'),
('1009','Hannah','Woodson','Neurology','Family Medicine','Prescriber','MBBS','9192383829','hannahwoodson@gmail.com','Female','11','TRUE','TRUE','20221129'),
('1010','Carla','Martin','Oncology','Orthopedic','Prescriber','MBBS','9192383830','carlamartin@gmail.com','Female','15','TRUE','TRUE','20221129'),
('1011','Casey','Arnold','Dermatology',NULL,'Prescriber','MBBS','9192383831','caseyarnold@gmail.com','Male','4','TRUE','TRUE','20221129'),
('1012','Macy','Pipin','Nurse Practioner',NULL,'Non Prescriber','BSN','9192383832','macypipin@gmail.com','Female','18','TRUE','TRUE','20221129'),
('1013','John','Shelvey','General Physician','Family Medicine','Prescriber','MD','9192383833','johnshelvey@gmail.com','Male','2','TRUE','TRUE','20221129');
...
CREATE TABLE `affiliation` (
    `affiliaitionid` varchar(255) NOT NULL,
    `doctorid` varchar(255) NOT NULL,
    `hospitalid` varchar(255) NOT NULL,
...
CREATE TABLE `users` (
	...
	`phone` varchar(255) NOT NULL,
	`isactive` varchar(255) NOT NULL,
	`lastmoddate` varchar(255) NOT NULLL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
